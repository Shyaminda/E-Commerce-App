...
import { addToWishList, createProduct, deleteImages, deleteProduct, getAllProducts, getProduct, rating, updateProduct, uploadImages } from '../controllers/product.controller.js';
...
productRouter.put('/upload-images',authMiddleware,isAdmin,uploadPhoto.array('images', 10),productImgResize,uploadImages);     //here determines number of images to be uploaded to product
...
productRouter.delete('/delete-image/:id',authMiddleware,isAdmin,deleteImages);
