    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path='/admin' element={<MainLayout />}>
          ...
          <Route path='color/:id' element={<AddColor />} />       {/* both update function and create function are in the AddBrand */}      {/* the path should be same as the MainLayout key values */}
