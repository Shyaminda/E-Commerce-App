...
export const getAllProducts = createAsyncThunk("product/get-product", async (thunkAPI) => {    //this getAllProducts is used below addCases not the getProducts in return statement below 
    try{
